...
<div class="w3-container w3-half w3-margin-top">
  <div class="w3-container w3-card-4">
    <form method="post">
      <h2 class="w3-text-theme">Edit User</h2>
      ...
      <div class="w3-container w3-third w3-left-align">
        <button class="w3-btn w3-theme" type="submit" name="editUser"> Submit </button>
      </div>
      <div class="w3-container w3-third w3-center">
        <button class="w3-btn w3-theme" type="submit" name="reset"> Reset Password </button>
      </div>
    </form>
